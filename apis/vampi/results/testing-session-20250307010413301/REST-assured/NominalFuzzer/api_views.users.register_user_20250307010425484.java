...
@Order(1962)
public class api_views.users.register_user_20250307010425484{
...
String baseURL ="http://localhost:5001";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_username = "insaturable";
		request0_request_body.put("username" , request0_request_body_username);
		Object request0_request_body_password = "qI3lvc";
		request0_request_body.put("password" , request0_request_body_password);
		Object request0_request_body_email = "rhpiswvbg@s.gov";
	...
	@Test
	public void test_api_views.users.register_user_20250307010425484()  throws JSONException{
		test0();
	}
}

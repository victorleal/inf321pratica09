...
@Order(1571)
public class api_views.users.register_user_20250307010423163{
...
String baseURL ="http://localhost:5001";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_username = "antimerging";
		request0_request_body.put("username" , request0_request_body_username);
		Object request0_request_body_password = "\"QFtpuD3";
		request0_request_body.put("password" , request0_request_body_password);
		Object request0_request_body_email = "walus@sxglm.cz.co.uk";
	...
	@Test
	public void test_api_views.users.register_user_20250307010423163()  throws JSONException{
		test0();
	}
}

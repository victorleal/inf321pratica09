...
@Order(1767)
public class api_views.users.register_user_20250307010424279{
...
String baseURL ="http://localhost:5001";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_username = "otherwhence ";
		request0_request_body.put("username" , request0_request_body_username);
		Object request0_request_body_password = "Dixie";
		request0_request_body.put("password" , request0_request_body_password);
		Object request0_request_body_email = "bkky@live.com";
	...
	@Test
	public void test_api_views.users.register_user_20250307010424279()  throws JSONException{
		test0();
	}
}

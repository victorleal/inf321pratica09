...
@Order(772)
public class api_views.users.register_user_20250307010418456{
...
String baseURL ="http://localhost:5001";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_username = "artifact's";
		request0_request_body.put("username" , request0_request_body_username);
		Object request0_request_body_password = "5YJVxFT+Be#I1Ya1DH1";
		request0_request_body.put("password" , request0_request_body_password);
		Object request0_request_body_email = "azjxxqbxg@kb.gov";
	...
	@Test
	public void test_api_views.users.register_user_20250307010418456()  throws JSONException{
		test0();
	}
}

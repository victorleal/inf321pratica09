...
@Order(1980)
public class api_views.users.register_user_20250307010425488{
...
String baseURL ="http://localhost:5001";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_username = "emballonurid";
		request0_request_body.put("username" , request0_request_body_username);
		Object request0_request_body_password = "CAw5S\"M";
		request0_request_body.put("password" , request0_request_body_password);
		Object request0_request_body_email = "svlx@eoer.gov";
	...
	@Test
	public void test_api_views.users.register_user_20250307010425488()  throws JSONException{
		test0();
	}
}

...
@Order(1973)
public class api_views.users.register_user_20250307010425486{
...
String baseURL ="http://localhost:5001";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_username = "V";
		request0_request_body.put("username" , request0_request_body_username);
		Object request0_request_body_password = "pi1FgGf9";
		request0_request_body.put("password" , request0_request_body_password);
		Object request0_request_body_email = "cqpsoignx@tinwgc.it";
	...
	@Test
	public void test_api_views.users.register_user_20250307010425486()  throws JSONException{
		test0();
	}
}

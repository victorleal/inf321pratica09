...
@Order(1380)
public class api_views.users.register_user_20250307010422023{
...
String baseURL ="http://localhost:5001";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_username = "UA63 3090 4161 2929 5433 3792 2080 3";
		request0_request_body.put("username" , request0_request_body_username);
		Object request0_request_body_password = "5FRobHvLX0p59DrBCZkC";
		request0_request_body.put("password" , request0_request_body_password);
		Object request0_request_body_email = "falpkp@gmail.com";
	...
	@Test
	public void test_api_views.users.register_user_20250307010422023()  throws JSONException{
		test0();
	}
}

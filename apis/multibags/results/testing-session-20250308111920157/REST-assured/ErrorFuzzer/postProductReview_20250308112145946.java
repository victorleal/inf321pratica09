...
@Order(587)
public class postProductReview_20250308112145946{
...
String baseURL ="http://multibags.1dt.com.br/";
	...
	private void test0() throws JSONException{
		...
		Object request1_header_Content-Type = "application/json";
		//Build request
		...
		request1.header("Content-Type" , request1_header_Content-Type);
		//Build Response
		Response response1 = request1.when().get(baseURL+"/api/v1/auth/customers/profile");
		...
		Object request0_request_body_language = 6111380025093510144;
	...
	@Test
	public void test_postProductReview_20250308112145946()  throws JSONException{
		test0();
	}
}
